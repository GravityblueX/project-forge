...
- Evidence: tests `package.json: turbo test; client\package.json: jest; server\package.json: jest`; diagnostics `12 report artifacts, 0 logs`; release `1 git tags`
...
- Evidence: tests `projects\idea-triage-board\package.json: npm run build && node --test dist/tests/*.test.js; projects\personal-craft-console\package.json: npm run build && node --test dist/tests/*.test.js`; diagnostics `9 report artifacts, 0 logs`; release `4 git tags`
...
- Evidence: tests `1 Python test files`; diagnostics `21 report artifacts, 0 logs`; release `5 git tags, 3 release docs`
...
- Evidence: tests `scripts\study-apk-contract.ps1; scripts\verify-installable-apk.ps1`; diagnostics `21 report artifacts, 2 logs`; release `15 git tags, 13 release docs`
