...
- Evidence: tests `package.json: npm run test --prefix backend && npm run test --prefix frontend; backend\package.json: node --test "test/**/*.test.js"; frontend\package.json: node --test "test/**/*.test.js"`; diagnostics `51 report artifacts, 0 logs`; release `44 git tags, 1 release docs`
...
- Evidence: tests `package.json: turbo test; client\package.json: jest; server\package.json: jest`; diagnostics `16 report artifacts, 0 logs`; release `1 git tags`
...
- Evidence: tests `projects\idea-triage-board\package.json: npm run build && node --test dist/tests/*.test.js; projects\personal-craft-console\package.json: npm run build && node --test dist/tests/*.test.js`; diagnostics `14 report artifacts, 0 logs`; release `4 git tags`
...
- Score: `100`
- Remote: `git@github.com:GravityblueX/ashveil-console.git`
- Evidence: tests `package.json: npm run test --prefix backend && npm run test --prefix frontend; backend\package.json: node --test "test/**/*.test.js"; frontend\package.json: node --test "test/**/*.test.js"`; diagnostics `49 report artifacts, 0 logs`; release `44 git tags, 1 release docs`
...
- Evidence: tests `1 Python test files`; diagnostics `25 report artifacts, 0 logs`; release `5 git tags, 3 release docs`
...
- Evidence: tests `scripts\study-apk-contract.ps1; scripts\verify-installable-apk.ps1`; diagnostics `25 report artifacts, 2 logs`; release `15 git tags, 13 release docs`
