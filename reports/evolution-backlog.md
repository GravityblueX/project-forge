...
- Evidence: tests `package.json: turbo test; client\package.json: jest; server\package.json: jest`; diagnostics `10 report artifacts, 0 logs`; release `1 git tags`
...
- Evidence: tests `projects\idea-triage-board\package.json: npm run build && node --test dist/tests/*.test.js; projects\personal-craft-console\package.json: npm run build && node --test dist/tests/*.test.js`; diagnostics `7 report artifacts, 0 logs`; release `4 git tags`
...
- Evidence: tests `1 Python test files`; diagnostics `19 report artifacts, 0 logs`; release `5 git tags, 3 release docs`
...
- Evidence: tests `scripts\study-apk-contract.ps1; scripts\verify-installable-apk.ps1`; diagnostics `19 report artifacts, 2 logs`; release `15 git tags, 11 release docs`
