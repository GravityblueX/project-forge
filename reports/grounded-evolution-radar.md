...
| diagnostic artifacts | OK | debug-traces | 25 report artifacts, 0 logs |
| contract artifacts | OK | evidence-contracts | 6 contract artifact(s): docs\authorized-boundary-audit.json, docs\authorized-boundary-audit.md, docs\dependency-inventory.json, docs\dependency-inventory.md |
...
| diagnostic artifacts | OK | debug-traces | 49 report artifacts, 0 logs |
| contract artifacts | OK | evidence-contracts | 12 contract artifact(s): reports\api-surface.json, reports\api-surface.md, reports\bom.cdx.json, reports\dependency-sbom.md |
| safety boundary | OK | health-gates | explicit safety or authorization boundary found |
...
| contract artifacts | OK | evidence-contracts | 17 contract artifact(s): reports\adr-index.json, reports\adr-index.md, reports\bom.cdx.json, reports\catalog-info.json |
| safety boundary | OK | health-gates | explicit safety or authorization boundary found |
...
| dependency automation | OK | dependency-rhythm | automation config found |
| release evidence | OK | templateable-workflows | 44 git tags, 1 release docs |
| diagnostic artifacts | OK | debug-traces | 51 report artifacts, 0 logs |
| contract artifacts | OK | evidence-contracts | 15 contract artifact(s): reports\api-surface.json, reports\api-surface.md, reports\bom.cdx.json, reports\client-api-coverage.json |
| safety boundary | OK | health-gates | explicit safety or authorization boundary found |
...
| diagnostic artifacts | OK | debug-traces | 25 report artifacts, 2 logs |
| contract artifacts | OK | evidence-contracts | 20 contract artifact(s): docs\apk-installability-report-v0.5.4-study.8.json, docs\apk-installability-report-v0.5.4-study.8.md, docs\apk-installability-report-v0.5.4-study.9.json, docs\apk-installability-report-v0.5.4-study.9.md |
| safety boundary | OK | health-gates | explicit safety or authorization boundary found |
...
| diagnostic artifacts | OK | debug-traces | 16 report artifacts, 0 logs |
| contract artifacts | OK | evidence-contracts | 18 contract artifact(s): reports\api-surface.json, reports\api-surface.md, reports\bom.cdx.json, reports\client-api-coverage.json |
| safety boundary | OK | health-gates | explicit safety or authorization boundary found |
